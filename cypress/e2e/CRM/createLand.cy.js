describe('Fleet Login Tests', () => {
    ...
    it('should redirect to fleet demo page with demo credentials', () => {
      ...
      cy.origin('https://www.gpsandfleet3.net', () => {
        ...
        cy.get('#aLandmarkCreate')
          .should('be.visible')
          .click();
        
        // Wait for modal to be visible
        cy.get('#divCreateLandmark')
          .should('be.visible');

          // Type in the address
        cy.get('#txtCreateLandmarkAddress')
        .should('be.visible')
        .clear()
        .type('san ramon');
        ...
        cy.get('#txtCreateLandmarkRadius')
        .should('be.visible')
        .clear()
        .type('500');
        
        // Click the Submit button
        cy.get('#btnCreateLandmark')
          .should('be.visible')
          .click();
      ...
      cy.get('[title="Save Landmark"]')
        ...
        cy.get('.alert.alert-success')
          .should('be.visible')
          .should('contain', 'Landmark created Successfully');
